...
| 6k | Server-paged team directory | Validated role/search filters, bounded database pages, full matching counts, responsive shared table and legacy roster compatibility | Complete; integration and browser coverage included |
...
| 15d | KPI schema and calculation registry | Versioned definitions, approved calculation sources, direction-aware thresholds, scoped preview/test, immutable value snapshots and paged history | Complete; additive migration and permission integration coverage included |
| 15e | KPI administration | Permission-aware catalogue and form, draft preview, saved tests, activation, current health, calculation recording and paged trend history | Complete; client navigation and browser coverage included |
