    ...
    <fieldset disabled={saving || Object.values(testing).some(Boolean)} className="u-af2cbf6">
      ...
      <div style={sectionStyle}>
        <div className="u-c61bb35">
          ...
          <div className="flex-1">
            <div className="u-0c7a14e">Microsoft Teams</div>
            <div className="u-1a57d8f">Post to a channel via a Workflows (or legacy Incoming) webhook</div>
          </div>
        ...
        {cfg.teams.enabled && (
          <>
            <div className="form-group mb-12">
              ...
              <div className="u-761e1ff">In Teams: channel → ··· → Workflows → "Post to a channel when a webhook request is received". Legacy *.webhook.office.com connector URLs also work.</div>
            </div>
      ...
      <div style={sectionStyle}>
        <div className="u-c61bb35">
          ...
          <div className="flex-1">
            <div className="u-0c7a14e">Cisco Webex</div>
            <div className="u-1a57d8f">Send notifications via a Webex Bot</div>
          </div>
        ...
        {cfg.webex.enabled && (
          <>
            <div className="form-group mb-12">
              ...
              <div className="u-761e1ff">Create a bot at <strong>developer.webex.com</strong> and paste its Access Token here.</div>
            </div>
            <div className="form-group mb-12">
