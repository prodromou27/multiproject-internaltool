...
# JWT_SECRET, and CUSTOMER_FIELD_KEY with openssl-generated values. Refuses to
# overwrite an existing .env (back it up / remove it first).
set -euo pipefail
...
echo "    IMPORTANT: back up CUSTOMER_FIELD_KEY — losing it makes encrypted PII unrecoverable."
